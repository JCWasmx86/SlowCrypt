...
all:
	mkdir -p bin/obj
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/encrypt.o src/encrypt.c
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/decrypt.o src/decrypt.c
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/shared.o src/shared.c
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/keygen.o src/keygen.c
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/keydump.o src/keydump.c
	$(CC) $(CFLAGS) -fanalyzer -O3 -s -I"include" -c -o bin/obj/pwd2key.o src/pwd2key.c
...
all-noassert:
	mkdir -p bin/obj
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/encrypt.o src/encrypt.c
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/decrypt.o src/decrypt.c
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/shared.o src/shared.c
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/keygen.o src/keygen.c
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/keydump.o src/keydump.c
	$(CC) $(CFLAGS) -DNDEBUG -fanalyzer -O3 -s -I"include" -c -o bin/obj/pwd2key.o src/pwd2key.c
	$(CC) -o bin/encrypt bin/obj/encrypt.o bin/obj/shared.o $(LIBS)
	$(CC) -o bin/decrypt bin/obj/decrypt.o bin/obj/shared.o $(LIBS)
	$(CC) -o bin/keygen bin/obj/keygen.o bin/obj/shared.o $(LIBS)
	$(CC) -o bin/keydump bin/obj/keydump.o bin/obj/shared.o $(LIBS)
